...
| `product` | `cvm` |
| Finding `id` pattern | `cvm-{rel|sec|cost|eff}-NNN` (3-digit sequence per pillar) |
      ...
      "findings": [
        {
          ...
          "evidence": "8/8 instances in ap-guangzhou-3",
          "recommendation": "Distribute across ≥2 zones; use CLB multi-AZ backends",
          "effort": "medium"
        }
      ]
    },
  ...
  "recommendations": [
    {
      "priority": "High",
      "pillar": "reliability",
      "action": "Distribute across ≥2 zones; use CLB multi-AZ backends",
      "effort": "medium"
    }
  ],
  "trace": {
    "commands": [
      "tccli cvm DescribeInstances --Region ap-guangzhou (SecretKey=<masked>)"
    ],
    "request_ids": [
