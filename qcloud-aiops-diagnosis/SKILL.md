...
| `{{user.resource_id}}` | User | `ins-xxxxxx` |
| `{{user.resource_type}}` | User | `cvm` |
| `{{user.time_range}}` | User | `1h`, `24h` |
| `{{user.log_source}}` | User | `loki`, `cls` |
| `{{user.cluster_id}}` | User | `cls-xxxxxx` |
| `{{user.time_start}}` | User | `2026-06-09T10:00:00+08:00` |
| `{{user.time_end}}` | User | `2026-06-09T11:00:00+08:00` |
| `{{user.time_start_epoch}}` | Derived/User | `1780970400` |
| `{{user.time_end_epoch}}` | Derived/User | `1780974000` |
| `{{user.handoff_source}}` | User/Caller | `finops` |
| `{{user.finops_handoff}}` | FinOps | `{...}` |
| `{{user.inspection_handoff}}` | Inspection | `{...}` |
| `{{user.orchestration_mode}}` | User | `auto` |
